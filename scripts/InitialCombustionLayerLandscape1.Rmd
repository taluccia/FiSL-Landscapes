...
```
## Raster
Raster is producted and exported in EE https://code.earthengine.google.com/?scriptPath=users%2Factalucci%2FFiSL%3ALandscape1PixelToPointBurnedArea
```{r}
r1<-rast("../data/Landscape1Raster/FiSL-Landscape1.tif")
```
